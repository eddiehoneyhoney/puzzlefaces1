...
(function(object){
  ...
  document.observe('dom:loaded', function(){
    ...
    function win(){
          var msg = new SpeechSynthesisUtterance('Fabulous you win your memory is fantastic Congratulations. try the next. ');
msg.lang = 'en-US';
window.speechSynthesis.speak(msg);
      cards.each(function(card){
        ...
        window.location = "http://puzzlefaces.xama.online/puzzletechnology/";
     // shuffle.delay(17);
    }
