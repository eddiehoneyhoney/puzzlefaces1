...
(function(object) {
  ...
  document.observe('dom:loaded', function(){
    ...
    function hide(element){
      ...
      flip(element, 'flipbackfruit.png');
    }
...
window.speechSynthesis.speak(msg);
      ...
      window.location = "http://puzzlefaces.xama.online/puzzlemoney/";
